      ...
      <Router>
        <Routes>
          ...
          <Route
            exact
            path="/"
            element={<MenuPage name={"Main"} items={mainMenu} />}
          ></Route>
          <Route
            exact
            path="/hooks"
            element={<MenuPage name={"Hook"} items={hooksMenu} />}
          ></Route>
          <Route
            exact
            path="/hooks/usestate"
          ...
          ></Route>
          <Route exact path="/hooks/useref" element={page(RefTutorial)}></Route>
          <Route
            exact
          ...
          <Route
            exact
            path="/patterns"
            element={<MenuPage name={"Patterns"} items={designPatternMenu} />}
          ></Route>
          <Route exact path="/patterns/hoc" element={<HocPage />}></Route>
          <Route
          ...
          <Route
            exact
            path="/basics"
            element={<MenuPage name={"Basics"} items={basicsMenu} />}
          ></Route>
          <Route
            exact
